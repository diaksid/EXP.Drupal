...
<script src="http://maps.google.com/maps/api/js?key=AIzaSyDgoYbXoxVBIBfsStqPxr__8amafgl4eAE"></script>
<script>
  $(function () {
    var latlng = new google.maps.LatLng( <?php echo CONTACTS_LATITUDE; ?>, <?php echo CONTACTS_LONGITUDE; ?> );
    var settings = {
      zoom: 14,
      center: latlng,
